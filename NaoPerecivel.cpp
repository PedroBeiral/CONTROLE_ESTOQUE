...
NaoPerecivel::NaoPerecivel(const std::string& nome, const std::string& sku, const std::string& descricao,
...
void NaoPerecivel::mostrarDetalhes() const {
    std::cout << "Produto Não Perecível: " << nome << ", Preço: " << precoVenda
